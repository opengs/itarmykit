<template>
    <q-card flat bordered class="row q-pa-sm  bg-transparent">
        <div :class="'col ' + ($q.dark.isActive ? 'bg-grey-9' : 'bg-yellow-7')" style="max-width: 62px; height: 62px;"> <q-icon name="fa-solid fa-arrow-up" size="32px" class="q-pt-md q-pl-md"></q-icon></div>
