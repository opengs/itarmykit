...
export default {
  ...
  settings: {
    ...
    matrixQuiz: {
      ...
      body: "Ти генно-моджифікований Укрнацист зі львівської біолабораторії. Як відомо, нам всім промили мізки і ми думаємо так само. Впиши перше що впаде тобі на думки (ассоціацію) щоб довести це",
