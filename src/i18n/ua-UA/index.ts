...
export default {
  ...
  bootstrap: {
    ...
    data: {
      ...
      windows: "Перед тим як продовжити, переконайся що ти додав папку з даними в виндовс дефендер та антивірусні винятки. В іншому випадку всі завантажені дані будуть видалені.",
